...
const Blog = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Blog | Nucleas IT - Tech Insights & Digital Innovation</title>
        <meta name="description" content="Read the latest tech insights, digital innovation trends, and expert tips from Nucleas IT." />
      </Helmet>
